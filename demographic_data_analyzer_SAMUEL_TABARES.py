...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = pd.read_csv('C:/DISEÑO/Analisis de datos/Data/adult.data.csv')
    ...
    highest_earning_country_percentage = df[(df['native-country'] == highest_earning_country) & (df['salary'] == '>50K')]['native-country'].count() / df['native-country'].value_counts().max() * 100
